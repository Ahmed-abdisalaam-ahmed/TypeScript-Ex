...
const firstElementString = firstElement<string>(["shehab", "ahmed", "ali"])
console.log(firstElementString.toUpperCase())
const firstElementNumber = firstElement<number>([1,2,22,33,34])
console.log(firstElementNumber.toFixed(2))
const firstElementUser = firstElement<{name: string, age: number}>([{name: "shehab", age: 20}, {name: "ahmed", age: 21}, {name: "ali", age: 22}])
